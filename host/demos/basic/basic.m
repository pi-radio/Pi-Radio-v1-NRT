...
sdr0 = piradio.sdr.FullyDigital('ip', "10.1.1.44", 'isDebug', isDebug, ...
    'figNum', 101, 'name', 'revB-0007');
...
scToUse = 50;   % select a subcarrier to generate data for each DAC
